...
error_string:
    ...
    error_string_length = . - error_string
...
# writer error string to stderr
    li     0,4
    li     3,2

    lis    4,error_string@highest
    ori    4,4,error_string@higher
    rldicr 4,4,32,31
    oris   4,4,error_string@h
    ori    4,4,error_string@l
    li     5,error_string_length
    sc
